...
class PaymentContainer extends Component {
    ...
    getAccessToken = async() => {
        ...
        try {
            await PaymentActions.getAccessToken();
            if (!this.props.iamportError) {
                await PaymentActions.getMerchantUid({merchant_uid, accessToken: this.props.accessToken, amount: totalPrice});
...
export default connect((state) => ({
    ...
    userPostCode: state
        .payment
        .get('userPostCode'),
    userDetailAddress: state
        .payment
        .get('userDetailAddress'),
    userEmail: state
        .payment
        .get('userEmail'),
    memberLogged: state
